 ...
 *
*/
const uint8_t msg[64] = {0x47, 0x4F, 0x33, 0x00, 0x00, 0x00, 0x02, 0xC5,
...
const uint8_t key[16] = {0x64, 0x63, 0x47, 0x4F, 0x64, 0x63, 0x47, 0x4F,
                      	 0x64, 0x63, 0x47, 0x4F, 0x64, 0x63, 0x47, 0x4F};

const uint8_t iv[16] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                     	0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F};

uint8_t e_msg[64]; /* Output buffer for encrypted data (ciphertext). */
...
void loop()
{
	...
	AES_CBC128(e_msg, msg, 64, key, iv, true);  /* true means encrypt. */
