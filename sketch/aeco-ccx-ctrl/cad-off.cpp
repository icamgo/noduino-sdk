...
#define MAC_CAD_OFF				0x89
#define MAC_CAD_ON				0x8A
 ...
 *   0x1: All CAD On
*/
#define	MODE_CAD_OFF		0x0
#define	MODE_CAD_ON			0x1

int txcmd = MODE_CAD_OFF;
int old_txcmd = MODE_CAD_OFF;
...
void change_txcmd()
{
	...
	if (key_cnt % 12 == 0) {
		...
		if (MODE_CAD_ON == txcmd) {

			txcmd = MODE_CAD_OFF;

		} else if (MODE_CAD_OFF == txcmd) {
